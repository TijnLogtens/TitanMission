...
public class Test extends Application {
  ...
  private final double dt = 24*60*60;
     public void start(Stage stage) {
       ...
       CelestialBody nep = new CelestialBody(Masses.getmUranus(), 2.520721625280142E+12, 1.570265330931762E+12, -3.638605615637463E+03, 5.459468350572506E+03,0, Diameters.getdUranus(), sun_);
       ...
       CelestialBody ur = new CelestialBody(Masses.getmNeptune(), 4.344787551365745E+12, -1.083664718815018E+12, 1.292632887654737E+03, 5.305024140488896E+03, 0, Diameters.getdNeptune(), sun_);
        ...
        AnimationTimer timer = new AnimationTimer() {
          //int x=300; int y=300;
            ...
            public void handle(long l) {
                ...
                mercury.setTranslateX((points[0]/2E8)+ 500 - mercury.getRadius());
                mercury.setTranslateY((points[1]/2E8) + 500 -  mercury.getRadius());
                ...
                venus.setTranslateX((points1[0]/2E8) + 500 - venus.getRadius());
                venus.setTranslateY((points1[1]/2E8) + 500 -  venus.getRadius());
                ...
                double[] points2 = mar.update(dt);
                 mars.setTranslateX((points2[0]/2E8) + 500 - mars.getRadius());
                mars.setTranslateY((points2[1]/2E8) + 500 -  mars.getRadius());
                ...
                jupiter.setTranslateX((points3[0]/2E8) + 500 - jupiter.getRadius());
                jupiter.setTranslateY((points3[1]/2E8) + 500 -  jupiter.getRadius());
                ...
                saturn.setTranslateX((points4[0]/2E8) + 500 - saturn.getRadius());
                saturn.setTranslateY((points4[1]/2E8) + 500 -  saturn.getRadius());
                ...
                neptune.setTranslateX((points5[0]/2E8) + 500 - neptune.getRadius());
                neptune.setTranslateY((points5[1]/2E8) + 500 -  neptune.getRadius());
                ...
                uranus.setTranslateX((points6[0]/2E8) + 500 - uranus.getRadius());
                uranus.setTranslateY((points6[1]/2E8) + 500 -  uranus.getRadius());
                ...
                earth.setTranslateX((points7[0]/2E8) + 500 - earth.getRadius());
                earth.setTranslateY((points7[1]/2E8) + 500 -  earth.getRadius());
